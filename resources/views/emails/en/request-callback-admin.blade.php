...
@section('title')
    New Callback Request Submitted - start easy.
@endsection
@section('content')
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding:32px; color:#DBDBDB;" class="content">
                ...
                <h5 style="font-size:16px; font-weight:600; margin:0 0 24px 0; line-height:24px;">New Callback Request Submitted</h5>
                    ...
                    <tr>
                        <td style="padding: 16px;">
                            <table>
                                ...
                                <tr>
                                    <th style="text-align: left; color: #8a8a8a">Phone/Email</th>
                                    <td style="text-align: left; padding-left: 24px">{{ $data['phoneOrEmail'] }}</td>
                                </tr>
                                <tr>
                                    <td style="height: 16px"></td>
                                    <td style="height: 16px"></td>
                                ...
                                <tr>
                                    <th style="text-align: left; color: #8a8a8a">Communication Mode</th>
                                    <td style="text-align: left; padding-left: 24px">{{ $data['communication'] }}</td>
                                </tr>
                                <tr>
                                    <td style="height: 16px"></td>
                                    <td style="height: 16px"></td>
