...
@section('title')
    تم إرسال طلب إعادة اتصال جديد - ستارت إيزي.
@endsection
@section('content')
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" dir="rtl">
        <tr>
            <td style="padding:32px; color:#DBDBDB; text-align: right;" class="content">
                ...
                <h5 style="font-size:16px; font-weight:600; margin:0 0 24px 0; line-height:24px;">تم إرسال طلب إعادة اتصال جديد</h5>
                    ...
                    <tr>
                        <td style="padding: 16px;">
                            <table>
                                ...
                                <tr>
                                    <th style="text-align: right; color: #8a8a8a">الهاتف/البريد الإلكتروني</th>
                                    <td style="text-align: right; padding-right: 24px">{{ $data['phoneOrEmail'] }}</td>
                                </tr>
                                <tr>
                                    <td style="height: 16px"></td>
                                    <td style="height: 16px"></td>
                                ...
                                <tr>
                                    <th style="text-align: right; color: #8a8a8a">طريقة التواصل</th>
                                    <td style="text-align: right; padding-right: 24px">{{ $data['communication'] }}</td>
                                </tr>
                                <tr>
                                    <td style="height: 16px"></td>
                                    <td style="height: 16px"></td>
